...
(function() {
  window.onload = function() {
    var backVideoCanvas, backVideoCtx, blobDetector, canvasBack, canvasDebug, canvasFront, canvasWeather, ctxBack, ctxDebug, ctxFront, ctxWeather, cv, debugCanvas, debugCtx, debugVideoCanvas, debugVideoCtx, frontVideoCanvas, frontVideoCtx, game, grammar, recognition, speechRecognitionList, video, webcam;
    $('#loading').hide();
    ...
    } else if (window.SpeechRecognition != null) {
      recognition = new SpeechRecognition();
      speechRecognitionList = new SpeechGrammarList();
    } else {
      console.log('No mic.');
    }
    if ((recognition != null) && recognition !== null) {
      ...
      recognition.onerror = function(e) {
        return console.log('Speech recognition error detected: ' + e.error);
      };
    ...
    document.getElementById('speech_result').onclick = function() {
