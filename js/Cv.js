...
(function() {
  ...
  Cv = (function() {
    ...
    Cv.prototype.getColorBoundsRect = function(imageData, color, threshold) {
      var i, j, pos, rect, ref, xMax, xMin, yMax, yMin;
    ...
    Cv.prototype.convolute = function(imageData, weights, opaque) {
      var a, alphaFac, b, dst, dstOff, g, h, halfSide, j, k, m, n, output, r, ref, ref1, ref2, ref3, scx, scy, sh, side, src, srcOff, sw, sx, sy, w, wt, wx, wy, x, y;
      ...
      for (y = j = 0, ref = h - 1; 0 <= ref ? j <= ref : j >= ref; y = 0 <= ref ? ++j : --j) {
        for (x = k = 0, ref1 = w - 1; 0 <= ref1 ? k <= ref1 : k >= ref1; x = 0 <= ref1 ? ++k : --k) {
          sx = x;
          sy = y;
          dstOff = (y * w + x) * 4;
          r = g = b = a = 0;
          for (wy = m = 0, ref2 = side - 1; 0 <= ref2 ? m <= ref2 : m >= ref2; wy = 0 <= ref2 ? ++m : --m) {
            for (wx = n = 0, ref3 = side - 1; 0 <= ref3 ? n <= ref3 : n >= ref3; wx = 0 <= ref3 ? ++n : --n) {
              scy = sy + wy - halfSide;
              scx = sx + wx - halfSide;
    ...
    Cv.prototype.blend = function(sourceData1, sourceData2, filter) {
      var average1, average2, blendedData, data1, data2, dataBlend, diff, height, i, j, k, len, len1, len2, m, n, ref, ref1, ref2, ref3, ref4, ref5, ref6, ref7, width;
      ...
      switch (filter) {
        case "add":
          ...
          for (i = j = 0, ref = len; j <= ref; i = j += 4) {
            dataBlend[i] = (ref1 = data1[i] + data2[i] > 255) != null ? ref1 : {
              255: data1[i] + data2[i]
            };
            dataBlend[i + 1] = (ref2 = data1[i + 1] + data2[i + 1] > 255) != null ? ref2 : {
              255: data1[i + 1] + data2[i + 1]
            };
            dataBlend[i + 2] = (ref3 = data1[i + 2] + data2[i + 2] > 255) != null ? ref3 : {
        ...
        case "multiply":
          ...
          for (i = k = 0, ref4 = len; k <= ref4; i = k += 4) {
        ...
        case "difference":
          ...
          for (i = m = 0, ref5 = len; m <= ref5; i = m += 4) {
        ...
        case "differenceAverage":
          for (i = n = 0, ref6 = len; n <= ref6; i = n += 4) {
            average1 = (data1[i] + data1[i + 1] + data1[i + 2]) / 3;
            average2 = (data2[i] + data2[i + 1] + data2[i + 2]) / 3;
            diff = (ref7 = this.fastAbs(average1 - average2) > 20) != null ? ref7 : {
              255: 0
            };
            target[i] = diff;
            target[i + 1] = diff;
    ...
    Cv.prototype.threshold = function(srcImageData, rule, value, colorOut) {
      var average, data, dataThreshold, height, i, j, k, len, m, n, ref, ref1, ref2, ref3, thresholdImageData, width;
      ...
      switch (rule) {
        case "<":
          ...
          break;
        case ">":
          for (i = k = 0, ref1 = len; k <= ref1; i = k += 4) {
            average = (data[i] + data[i + 1] + data[i + 2]) / 3;
            if (average > value) {
              dataThreshold[i] = colorOut;
            }
          ...
          break;
        case "!":
          for (i = m = 0, ref2 = len; m <= ref2; i = m += 4) {
            average = (data[i] + data[i + 1] + data[i + 2]) / 3;
            if (average !== value) {
              dataThreshold[i] = colorOut;
            }
          ...
          break;
        case "===":
          for (i = n = 0, ref3 = len; n <= ref3; i = n += 4) {
            average = (data[i] + data[i + 1] + data[i + 2]) / 3;
            if (average === value) {
              dataThreshold[i] = colorOut;
            }
